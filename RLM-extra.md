# RLM-extra.md - Detailed Reference for Recursive Language Models

> **Start here:** For actionable instructions, see **[RLM.md](RLM.md)** first.
> This file contains detailed reference material: architecture, benchmarks, prompt templates, error handling, and bash scripts.

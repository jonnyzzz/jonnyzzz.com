...
**Tags:** kotlin, coroutine, kotlin-bytecode, jvm, tip
...
The new thing in Kotlin 1.1 is [coroutines](http://kotlinlang.org/docs/reference/coroutines.html). As we know
...
The interface `Continuation` is declared in the Kotlin standard library, see [documentation](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.coroutines.experimental/).

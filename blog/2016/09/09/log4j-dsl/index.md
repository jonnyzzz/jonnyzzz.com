...
**Tags:** log4j, logging, dsl, the dsl way, kotlin, jvm, ide
...
how [The DSL Way]({% post_url blog/2016-09-02-dsl-building %}) is applied here.
...
See [The DSL Way]({% post_url blog/2016-09-02-dsl-building %}) post for more details on the approach
...
into [The DSL Way]({% post_url blog/2016-09-02-dsl-building %}) approach.

You may have a look (or contribute) to the project sources on [my GitHub](https://github.com/jonnyzzz/Log4j2DSL)

You may follow to [this post]( {% post_url blog/2016-03-08-gradle-for-dsl %}) for details on how to create 

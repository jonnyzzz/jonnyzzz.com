...
**Tags:** dsl, the dsl way, kotlin, jvm, ide
...
[The DSL Way]({% post_url blog/2016-09-02-dsl-building %}) approach
too. 
...
[loggers]({% post_url blog/2016-09-09-log4j-dsl %}). 
...
[The DSL Way]({% post_url blog/2016-09-02-dsl-building %})
...
[the post]({% post_url blog/2016-09-09-log4j-dsl %})
